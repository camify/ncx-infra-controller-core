...
pub async fn handle_validating(
    ...
    tracing::info!("Validating Switch");
    ...
    match validating_state {
        ValidatingState::ValidateComplete => {
            tracing::info!("Validating Switch: ValidateComplete");
            Ok(StateHandlerOutcome::transition(
                SwitchControllerState::BomValidating {
                    bom_validating_state: BomValidatingState::BomValidateComplete,
                },
            ))
        }
    }
